...
def image_inference(model, sam_predictor, vis_folder, path, output_base_path, current_time):
    ...
    for image_name in files:
        ...
        try:    
            ...
            results = get_model(model, image_name, 2048, 2048)
            person_bboxes=[]
            ...
            for result in results:
                ...
                for box, class_id in zip(boxes, class_ids):
                    if int(class_id) == 0  or int(class_id) == 77   or  int(class_id) == 22  or int(class_id) == 21 or int(class_id) == 16 or int(class_id) == 17 or int(class_id) == 18 or  int(class_id) == 18:  # Class ID 0 corresponds to "person"
