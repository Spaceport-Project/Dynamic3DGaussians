...
def load_cameras_params(calib_cameras_data_path):
    ...
    # center = np.array([1.8088410405e+00, 1.2060417274e+00, -3.6292783610e+00])  # agisoft
    ...
    for cam_idx in range(num_cameras):
        ...
        scale = 3.3299749231959184/1.5613605042983059
...
def load_xml_camera_params(file_name) :
    ...
    for id, cam in enumerate(data_dict['document']['chunk']['cameras']['camera']):
        ...
        cam_pose_list.append(np.array(transform).reshape(4,4).tolist())
...
def main():
    ...
    # with multiprocessing.Pool(processes=2) as pool_masking:
