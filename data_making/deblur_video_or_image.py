...
def main():
    ...
    # cv2.waitKey(0)
    # frame = cv2.imread('/home/hamit/DATA/processed_data/2025-03-27_15-46-48/ims_final/11/000000.png')
    # ## calling the algorithm function
    # op_image = process(frame)
    # cv2.imwrite("deblurred_0.png", op_image)

    
    image = cv2.imread('/home/hamit/DATA/processed_data/2025-03-27_15-46-48/ims_final/11/000000.png')

    # sharpen_kernel = np.array([[-1,-1,-1], [-1,9,-1], [-1,-1,-1]])
    # sharpen = cv2.filter2D(image, 0 , sharpen_kernel)

    # deblurred = cv2.fastNlMeansDenoisingColored(sharpen,None,5,5,7,21)
...
# applying kernels to the input image to get the sharpened image
    ...
    cv2.imshow('deblureed.png', sharp_image)
    cv2.waitKey ()
