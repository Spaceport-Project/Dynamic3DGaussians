...
def image_inference(model, sam_predictor, vis_folder, path, output_base_path, current_time):
    ...
    for image_name in files:
        ...
        try:    
            ...
            results = model(image_name, imgsz=(1024, 1156))
            ...
            # Check if the detection is a person (class 0)
                ...
                # if r.boxes is not None:
                    ...
                    for idx in person_indices:
                        ...
                        box = boxes[idx]
                        # print(f"  Bounding Box: x1={box[0]:.2f}, y1={box[1]:.2f}, x2={box[2]:.2f}, y2={box[3]:.2f}", (box[2]-box[0])*(box[3]-box[1]))
                        box_area = (box[2]-box[0])*(box[3]-box[1])
                        print(f"Box area[{idx}]={box_area}")
                        if abs(box_area) > 150000:
