...
def load_and_prepare_image(image_path):  
    ...
    print(f"Grayscale image shape: {im.shape}")  
      
    return im  
im = load_and_prepare_image('/home/hamit/DATA/processed_data/2025-03-27_15-46-48/ims_final/11/000000.png')  

# img = Image.open('/home/hamit/DATA/processed_data/2025-03-27_15-46-48/ims_final/11/000000.png')  
# im = np.array(img)  
