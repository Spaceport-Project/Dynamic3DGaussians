...
def train(seq, exp, scale=1):
    ...
    if num_timesteps > save_interval:
        ...
        save_iterations = []
    init_params_file = f"./data/{seq}/init_pt_cld_120.npz"
    ...
    # for t in range(num_timesteps):
        ...
        num_iter_per_timestep_for_non_key_frames = int(1200)
...
if __name__ == "__main__":
    ...
    # exp_name = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned_test3"
    # for sequence in ["2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned"]:
    ...
    # exp_name = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_scl1_test2"
    # for sequence in ["2025-05-20_18-24-20_hamit_burak_1_lumi_adj_aligned"]:


    # exp_name = "2025-08-06_16-07-58_combin2_test3"
    # for sequence in ["2025-08-06_16-07-58_combin2"]:

    # exp_name = "2025-08-06_16-09-24_3412x2500_combin2_test2"    
    # for sequence in ["2025-08-06_16-09-24_3412x2500_combin2"]:
    
    # exp_name = "2025-08-06_16-09-24_3412x2500_combin2_3_test2"    
    # for sequence in ["2025-08-06_16-09-24_3412x2500_combin2_3"]:

    exp_name = "2025-08-06_16-09-24_3412x2500_combin2_2_test1_start_118_4_cam_m_c"    
