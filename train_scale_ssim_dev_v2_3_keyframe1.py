...
from helpers_scl import combined_color_loss_v2,combined_color_loss_v1, convert_rgb_to_hsv, fetchPly, l1_loss_v1_noblack, l2_loss_v1, l2_loss_v2, params2cpu2,  pytorch3d_knn, save_params_init, separate_gray_loss, separate_gray_loss_hsv, separate_gray_loss_hsv_smooth, separate_gray_loss_lab, separate_gray_loss_lab_smooth, setup_camera, l1_loss_v1, l1_loss_v2, weighted_l2_loss_v1, weighted_l2_loss_v2, quat_mult, \
...
def train(seq, exp, scale=1):
    ...
    if num_timesteps > save_interval:
        ...
        save_iterations = []
    init_params_file = f"./data/{seq}/init_pt_cld_939.npz"
    ...
    # for t in range(num_timesteps):
        ...
        if is_key_timestep: #and not skip_to_next_timestamp:
            # save_params_init(output_params, seq, exp)
...
if __name__ == "__main__":
    ...
    # for sequence in ["2025-08-06_16-38-56_3412x2500_combin3"]:

    exp_name = "2025-08-06_15-29-41_3412x2500_combin1_test4_939"
    for sequence in ["2025-08-06_15-29-41_3412x2500_combin1"]:
