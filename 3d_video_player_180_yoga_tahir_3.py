...
class RenderViewers():
    ...
    def init_camera(cls, y_angle=180., center_dist=5., cam_height= 1.5, f_ratio=0.82):
        ...
        w2c = np.array([[np.cos(ry), 0., -np.sin(ry), -0.0],
                        ...
                        [0.,         0., 0.,          1.]])
    #     c2w = np.array([[ 9.62066058e-01, -6.32957349e-03,  2.72743171e-01,
    #     -3.89266379e+00],
    #    [ 2.80760639e-03,  9.99907590e-01,  1.33014724e-02,
    #      3.66515055e-01],
    #    [-2.72802159e-01, -1.20311396e-02,  9.61994924e-01,
    #     -7.63561329e+00],
    #    [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,
    #      1.00000000e+00]])
        c2w = np. array([[ 9.72335370e-01,  1.59041370e-02,  2.33047176e-01,
        -2.81683672e+00],
       [ 3.58322731e-05,  9.97669294e-01, -6.82347256e-02,
         1.68689742e+00],
       [-2.33589227e-01,  6.63553877e-02,  9.70068573e-01,
        -4.80637746e+00],
       [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,
         1.00000000e+00]])
        # c2w = np.linalg.inv(w2c)
...
if __name__ == "__main__":
    ...
    # exp_name = "2025-05-20_18-21-50_tahir2_fullsize_scl_2_contrast_alpha14"
    # sequence = "2025-05-20_18-21-50_tahir2"

    # exp_name = "2025-05-20_18-21-50_tahir2_fullsize_scl_1_contrast_alpha14_aligned_half"
    # sequence = "2025-05-20_18-21-50_tahir_2_half_aligned"

    # exp_name = "2025-05-20_18-21-50_tahir2_fullsize_scl_1_contrast_alpha14_aligned_half_test1"
    # sequence = "2025-05-20_18-21-50_tahir_2_half_aligned"

    # exp_name = "2025-05-20_18-21-50_tahir2_fullsize_scl_1_contrast_alpha14_aligned_half_test12"
    # sequence = "2025-05-20_18-21-50_tahir_2_half_aligned"

    # exp_name = "2025-05-20_18-21-50_tahir_2_half_low_error_scl_1_contrast_alpha14_aligned_half_test1"
    # sequence = "2025-05-20_18-21-50_tahir_2_half_low_error"

    # exp_name = "2025-05-20_18-21-50_tahir_2_half_all_low_error_scl_1_enhanced_600"
    # sequence = "2025-05-20_18-21-50_tahir_2_half_all_low_error"

    exp_name = "2025-05-20_18-21-50_tahir_2_half_all_low_error_scl_1_enhanced_60_dev10"
    sequence = "2025-05-20_18-21-50_tahir_2_half_all_low_error"
