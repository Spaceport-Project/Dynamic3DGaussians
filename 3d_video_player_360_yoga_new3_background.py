...
class RenderViewers():
    ...
    def __init__(self, viewer, client ):
        ...
        # with client.gui.add_modal("Modal example") as modal:
        ...
        #     #     "Title",
        #     #     initial_value="Modal example",
        #     # )

        #     modal_button = client.gui.add_button("Show more modals", visible=True,icon=viser.Icon.PLAYER_SKIP_BACK,  
        #                                                         color="white")
        ...
        #         #     client.gui.add_button("Close", visible=True,icon=viser.Icon.PLAYER_PLAY,  
        #         #                                                 color="white").on_click(lambda _: modal.close())
        # # self.gui_modal = client.gui.add_modal("Modal example"):
        # # self.gui_modal.
    ...
    def _render(self, c2w, timestep_data, gaussians, bg=[0,0,0], is_cam_pose_changed=True, theta=180):
        with torch.no_grad():
            ...
            if is_cam_pose_changed:
                ...
                cam_dict["sh_degree"] = 0 #gaussians[1]
...
if __name__ == "__main__":
    ...
    viewer = Viewer(seq=sequence, exp=exp_name, pc_path=pc_path, port=8089, title="360° Demo10 Spaceport", w=1920, h=1080, max_sh_degree=3)
    time.sleep(0.2)
    viewer.start_viewer()
