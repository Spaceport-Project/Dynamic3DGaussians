...
def train(seq, exp, scale=1):
    ...
    if num_timesteps > save_interval:
        ...
        save_iterations = []
    init_params_file = f"./data/{seq}/init_pt_cld_542.npz"
    # init_params_file = f"./data/{seq}/points3D.ply"
...
if __name__ == "__main__":
    ...
    exp_name = "2025-11-12_14-37-30_aliyenur_ahmet_1_50-1850_542"
    for sequence in ["2025-11-12_14-37-30_aliyenur_ahmet_1_50-1850"]:
