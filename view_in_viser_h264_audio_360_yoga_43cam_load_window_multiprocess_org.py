...
class RenderViewers():
        ...
        if isinstance(item, dict):
            for key, value in item.items():
                if hasattr(value, 'is_cuda') and value.is_cuda:
                    val = value.detach().cpu()  # Detach from computation graph
                    print("Deleting ", key)
    ...
    # def __del__(self):
    #     """Ensure cleanup runs during garbage collection"""
    ...
    #     # Set all events
    #     events = ['encode_event', 'cuda_event', 'load_event', 'render_event', 'render_ready_event']
    #     for event_name in events:
    #         if hasattr(self, event_name):
    #             getattr(self, event_name).set()

    #     # First cleanup CUDA IPC resources
    #     self.cleanup_cuda_ipc()

    #     # Terminate render process with proper cleanup
    #     if hasattr(self, 'render_process') and self.render_process.is_alive():
    #         try:
    #             # Send termination signal to render process
    #             self.render_process.terminate()
    #             # Wait for process to cleanup
    #             self.render_process.join(timeout=3)
    #             if self.render_process.is_alive():
    #                 print("Force killing render process")
    ...
    #     # Close queues
    #     queues = ['render_input_queue', 'render_output_queue']
    #     for queue_name in queues:
    #         if hasattr(self, queue_name):
    #             try:
    #                 queue = getattr(self, queue_name)
    #                 queue.cancel_join_thread()  # Don't wait for background thread
    #                 queue.close()
    #             except Exception as e:
    #                 print(f"Error closing {queue_name}: {e}")
    ...
    #     # Set all events to prevent deadlocks
    #     if hasattr(self, 'encode_event'):
    #         self.encode_event.set()
    #     if hasattr(self, 'cuda_event'):
    #         self.cuda_event.set()
    #     if hasattr(self, 'load_event'):
    #         self.load_event.set()
    #     if hasattr(self, 'render_event'):
    #         self.render_event.set()
    #     if hasattr(self, 'render_ready_event'):
    #         self.render_ready_event.set()
    ...
    #         while not self.render_input_queue.empty():
    #             try:
    #                 w2c, scene_data = self.render_input_queue.get_nowait()
    #                 self.deep_clear_cuda(scene_data)
    #             except Empty:
    #                 break

    #         while not self.render_output_queue.empty():
    #             try:
    #                 img = self.render_output_queue.get_nowait()
    #                 if torch.is_tensor(img) and img.is_cuda:
    #                     img.cpu()
    #                     del img
    #             except Empty:
    #                 break
    ...
    #     # Terminate render process first
    #     if hasattr(self, 'render_process') and self.render_process.is_alive():
    #         try:
    #             self.render_process.terminate()
    ...
    #     try:
    #         if hasattr(self, 'render_input_queue'):
    #             self.render_input_queue.close()
    #             self.render_input_queue.join_thread()
    #         if hasattr(self, 'render_output_queue'):
    #             self.render_output_queue.close()
    #             self.render_output_queue.join_thread()
    #     except Exception as e:
    ...
    #                 thread.join(timeout=2)
    #                 if thread.is_alive():
    #                     print(f"Warning: {thread_name} did not terminate properly")
    #             except Exception as e:
    #                 print(f"Error joining {thread_name}: {e}")

    #     # Clear scene data queue
    #     try:
    #         while hasattr(self, 'scene_data') and not self.scene_data.empty():
    #             item = self.scene_data.get_nowait()
    #             self.deep_clear_cuda(item)
    ...
    #     # Final CUDA cleanup
    #     try:
    #         if hasattr(self, 'img') and torch.is_tensor(self.img) and self.img.is_cuda:
    #             self.img.cpu()
    #             del self.img
    ...
    #     # Terminate and join render process
    #     if hasattr(self, 'render_process') and self.render_process.is_alive():
    #         self.render_process.terminate()
    ...
    #     self.show_live_cuda_tensors()
    #     while hasattr(self, 'scene_data') and not self.scene_data.empty():
    #         it = self.scene_data.get()
    #         self.deep_clear_cuda(it)
...
if __name__ == "__main__":
    ...
    exp_name = "2025-08-06_3412x2500_combin1_all_tmp"
