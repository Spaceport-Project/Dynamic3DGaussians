...
if __name__ == "__main__":
    ...
    exp_name = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned_test1"
    sequence = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned" 
    

        
    viewer = Viewer(seq=sequence, exp=exp_name,  port=8084, title="180° Demo6 Spaceport", w=1920, h=1080)
    time.sleep(0.2)
    viewer.start_viewer()
