...
def train(seq, exp, scale=1):
    ...
    num_iter_per_timestep_for_non_key_frames = 1000
    ...
    # for t in range(num_timesteps):
        ...
        # for i in range(num_iter_per_timestep):
            ...
            with torch.no_grad():
                try:
                    report_progress(params, dataset[dataset_id], i + 1, progress_bar, every_i)
                ...
                #     if is_key_timestep == False and i >= num_iter_per_timestep_for_non_key_frames - 1 and i < num_iter_per_timestep_for_non_key_frames * 2 and psnr  >= psnr_init - psnr_lower_margin:
                #         every_i = every_big
                #         psnr_lower_limit_var = psnr_lower_limit
                #         psnr_nonkeyfr_limit = psnr
                ...
                #         progress_bar = tqdm(range(num_iter_per_timestep), desc=f"timestep {t}")
                #     if is_key_timestep == True and i > num_iter_per_timestep_for_key_frames and psnr >= psnr_lower_limit_var:
                #         psnr_init = psnr
                #         every_i = every_big
                #         psnr_lower_limit_var = psnr_lower_limit
                #         last_key_frame = t
...
if __name__ == "__main__":
    ...
    exp_name = "2025-05-20_18-21-50_tahir2_fullsize_scl_2_ai_contrast_alpha14_single"
    for sequence in ["2025-05-20_18-21-50_tahir2"]:
