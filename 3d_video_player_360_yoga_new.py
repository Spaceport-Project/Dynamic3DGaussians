        ...
        while self.running:
            ...
            # for t in range(num_timestamps): 
                ...
                while True:
                    ...
                    if old_proggress_bar_value + 30 < self.gui_slider_bar_text.value  or old_proggress_bar_value - 30 > self.gui_slider_bar_text.value:
...
if __name__ == "__main__":
    ...
    viewer = Viewer(seq=sequence, exp=exp_name, port=8089, title="Demo10 Spaceport", w=1920, h=1080)
    time.sleep(0.2)
    viewer.start_viewer()
