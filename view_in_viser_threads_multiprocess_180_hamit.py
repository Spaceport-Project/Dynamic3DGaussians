...
class RenderViewers():
    ...
    # look_at =  np.array([2.1585774, 2.44196775, 4.75468816])
    look_at =  np.array([2.1585774, 1.88, 3.29])
    ...
    def init_camera(cls, y_angle=-90., center_dist=-0.80, cam_height= -1.5, f_ratio=0.82):
