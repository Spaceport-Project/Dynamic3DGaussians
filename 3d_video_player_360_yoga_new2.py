...
class Viewer():
    ...
    def __init__(self, seq, exp, port=8082, title = "", f_ratio=0.8, w=1920, h=1080, near=0.01, far=100.0):
        self.seq = seq
        self.exp = exp
    ...
    def _load_scene_data3(self, seq, exp, seg_as_col=False):
        ...
        for l, param_file  in enumerate(params_file):
            ...
            try:
                ...
                print(f"Error {param_file} cannot open, {e}")
...
class RenderViewers():
        ...
        while self.running:
            ...
            # for t in range(num_timestamps): 
                ...
                while True:
                    ...
                    # if theta == self.theta_limits[0] or theta == self.theta_limits[1]:
                    ...
                    self.img = self._render(w2c, self.scene_data[t], bg= [220./255, 220./255, 220./255])  #  bg=[0, 170.0/255, 64.0/255]
    ...
    def init_camera(cls, y_angle=0., center_dist=4., cam_height= 3., f_ratio=0.82):
        ...
        c2w = np.array([[-0.94743326, -0.0982282 , -0.30450196,  1.56 ],
                [-0.09894314,  0.99500657, -0.01312203 , -0.4],
                [ 0.3042704 ,  0.01769613, -0.95242132,  4.5],
                [ 0.  ,        0.    ,      0.  ,        1.        ]])
...
if __name__ == "__main__":
    ...
    # exp_name = "2025-08-06_15-44-12_3412x2500_combin1_167_test2"
    # sequence = "2025-08-06_15-44-12_3412x2500_combin1_167"
    ...
    exp_name ="2025-11-12_14-37-30_aliyenur_ahmet_1_50-150_test1_50"
    sequence ="2025-11-12_14-37-30_aliyenur_ahmet_1_50-150"

    exp_name ="2025-11-12_14-37-30_aliyenur_ahmet_1_50-150_test2_0"
    sequence ="2025-11-12_14-37-30_aliyenur_ahmet_1_50-150"


    exp_name ="2025-11-12_14-37-30_aliyenur_ahmet_1_150-550_test2_50"
    sequence ="2025-11-12_14-37-30_aliyenur_ahmet_1_150-550"

    exp_name ="2025-11-12_14-37-30_aliyenur_ahmet_1_50-550"
    sequence ="2025-11-12_14-37-30_aliyenur_ahmet_1_50-550"

    exp_name ="2025-11-12_14-37-30_aliyenur_ahmet_1_50-1850_0"
    ...
    viewer = Viewer(seq=sequence, exp=exp_name, port=8093, title="360° Demo8 Spaceport", w=1920, h=1080)
    time.sleep(0.2)
    viewer.start_viewer()
