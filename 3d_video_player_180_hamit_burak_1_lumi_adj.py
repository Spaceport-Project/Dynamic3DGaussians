...
class RenderViewers():
        ...
        while self.running:
            ...
            while t < num_timestamps:
                ...
                while True:
                    ...
                    self.img = self._render(w2c, self.scene_data[t],bg=[240./255, 240./255, 240./255]) # bg=[0, 177.0/255, 64.0/255]
    ...
    def init_camera(cls, y_angle=180., center_dist=5., cam_height= 1.5, f_ratio=0.82):
        ...
        w2c = np.array([[np.cos(ry), 0., -np.sin(ry), -0.0],
                        ...
                        [0.,         0., 0.,          1.]])
        c2w = np.array([[ 0.99269664,  0.10564464, -0.05824602, -0.1320338 ],
       [-0.10482921,  0.9943468 ,  0.01689038,  0.79607679],
       [ 0.05970112, -0.01066114,  0.99815936, -6.06920851],
       [ 0.        ,  0.        ,  0.        ,  1.        ]])
...
if __name__ == "__main__":
    ...
    viewer = Viewer(seq=sequence, exp=exp_name,  port=8085, title="180° Demo5 Spaceport", w=1920, h=1080)
    time.sleep(0.2)
    viewer.start_viewer()
