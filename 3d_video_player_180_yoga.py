...
class RenderViewers():
    ...
    @classmethod
    def init_camera(cls, y_angle=90, center_dist=5., cam_height= 1.5, f_ratio=0.82):
...
if __name__ == "__main__":
    ...
    viewer = Viewer(seq=sequence, exp=exp_name,  port=8080, title="180° Demo1 Spaceport", w=1920, h=1080)
    time.sleep(0.2)
    viewer.start_viewer()
