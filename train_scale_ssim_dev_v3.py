...
class WeightedLoss(torch.nn.Module):
    ...
    def forward(self, losses):
        ...
        weights = weights * torch.tensor([1.0, 3.0, 4.0, 4.0, 2.0, 0.02], device=weights.device)  
...
def train(seq, exp, scale=1):
    ...
    criterion = WeightedLoss(num_losses=6)
...
if __name__ == "__main__":
    ...
    exp_name = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_scl1_weight_test8"
    for sequence in ["2025-05-20_18-24-20_hamit_burak_1_lumi_adj"]:
