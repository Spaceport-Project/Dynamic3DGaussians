        ...
        while self.running:
            ...
            # for t in range(num_timestamps): 
                ...
                while True:
                    ...
                    if phi < 0:
                        phi = 360 + phi
                    print("Phi and theta in degrees:", phi, theta, t)
                    ...
                    # print(old_proggress_bar_value, self.gui_slider_bar_text.value)
...
if __name__ == "__main__":
    ...
    # exp_name = "2024-12-04_17-14-42_10bestcams_scl_2_test1"
    # sequence = "2024-12-04_17-14-42_10bestcams"
    
    exp_name = "2024-12-04_17-14-42_8bestcams_scl_2_test1"
    sequence = "2024-12-04_17-14-42_8bestcams"
    ...
    viewer = Viewer(seq=sequence, exp=exp_name,  port=8084, title="8 Camera - Demo2 Spaceport", w=1920, h=1080)
    time.sleep(0.2)
    viewer.start_viewer()
