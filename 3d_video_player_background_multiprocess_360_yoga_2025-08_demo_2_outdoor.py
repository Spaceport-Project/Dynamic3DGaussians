...
def load_bg_scene_data( pc_path, max_sh_degree=3):
        ...
        screenspace_points = torch.zeros_like(gaussians.get_xyz, dtype=gaussians.get_xyz.dtype, requires_grad=True, device="cpu") + 0
        try:
...
class RenderViewers():
    ...
    def __init__(self, viewer, client ):
        ...
        # self.bg_scene_data = viewer.bg_scene_data_shared
    ...
    @staticmethod
    def render_process_function(input_queue, output_queue, gaussians, max_sh, w, h, k, near, far, render_event, render_ready_event, running):
...
if __name__ == "__main__":
    ...
    # pc_path = "/home/ubuntu/splat_plys/Stone_Gravel_Patch_trans_sh_3.ply"

    # pc_path = "/home/ubuntu/splat_plys/8_25_2025_cleaned_scaled6.ply"
    # pc_path = "/home/ubuntu/splat_plys/bicycle_2_cleaned_trans_sh_3.ply"
    ...
    bg_scene_data, max_sh_degree = load_bg_scene_data(pc_path, max_sh_degree=0)
    bg_scene_data_shared = share_scene_data(bg_scene_data)
    
    viewer = Viewer(seq=sequence, exp=exp_name, pc_path=pc_path, port=8088, title="360° Demo9 Spaceport", w=1920, h=1080, max_sh_degree=0)
