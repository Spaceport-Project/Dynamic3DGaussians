...
from helpers_scl import combined_color_loss_v2,combined_color_loss_v1, convert_rgb_to_hsv, fetchPly, greedy_match_large_clouds, greedy_one_to_one_from_knn, l1_loss_v1_noblack, l2_loss_v1, l2_loss_v2, matching_point_clouds, params2cpu2,  pytorch3d_knn, save_params_init, separate_gray_loss, separate_gray_loss_hsv, separate_gray_loss_hsv_smooth, separate_gray_loss_lab, separate_gray_loss_lab_smooth, setup_camera, l1_loss_v1, l1_loss_v2, weighted_l2_loss_v1, weighted_l2_loss_v2, quat_mult, \
    o3d_knn, params2rendervar, params2cpu, save_params, save_params_multi
from external import accumulate_mean2d_gradient, accumulate_mean3d_gradient, calc_ssim, calc_psnr, build_rotation, calc_ssim_with_mask, densify, densify_nokeyframes, inverse_sigmoid, keep_points, np_inverse_sigmoid, update_params_and_optimizer
import shutil
...
def get_loss(params, optimizer, curr_data, variables, is_initial_timestep, i, list_ids, vertices):
    ...
    if  i %3 == 0 and ( curr_id == 6 or  curr_id == 19 or  curr_id == 31 or  curr_id == 40):
...
def train(seq, exp, scale=1):
    ...
    # for t in range(num_timesteps):
        ...
        num_iter_per_timestep_for_non_key_frames = int(2000)
        ...
        while True:
            ...
            with torch.no_grad():
                ...
                if i >= 700  and not is_key_timestep:
        ...
        if is_key_timestep: #and not skip_to_next_timestamp:
            save_params_init([params2cpu2(params, True)], seq, exp, t)
...
if __name__ == "__main__":
    ...
    # for sequence in ["2025-08-06_15-44-12_3412x2500_combin1_500"]:
    ...
    exp_name = "2025-11-12_14-37-30_aliyenur_ahmet_1_50-150_test2_0"
