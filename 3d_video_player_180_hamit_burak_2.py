...
class RenderViewers():
        ...
        while self.running:
            ...
            # for t in range(num_timestamps): 
                ...
                while True:
                    ...
                    if old_proggress_bar_value + 20 < self.gui_slider_bar_text.value  or old_proggress_bar_value - 15 > self.gui_slider_bar_text.value:
    ...
    def init_camera(cls, y_angle=180., center_dist=5., cam_height= 1.5, f_ratio=0.82):
        ...
        w2c = np.array([[np.cos(ry), 0., -np.sin(ry), -0.0],
                        ...
                        [0.,         0., 0.,          1.]])
        c2w = np.array([[-0.34044848, -0.09374587, -0.93557819,  6.36521627],
       [-0.05481836,  0.99530382, -0.07978254,  1.67719056],
       [ 0.93866383,  0.02412501, -0.34398867,  4.15409927],
       [ 0.        ,  0.        ,  0.        ,  1.        ]])
        # c2w = np.linalg.inv(w2c)
...
if __name__ == "__main__":
    ...
    sequence = "2025-05-20_18-28-33_hamit_burak_2_half_all"
