...
import torch
import numpy as np
from utils_gs.general_utils import inverse_sigmoid, get_expon_lr_func, build_rotation
from torch import nn
import os
import json
from utils_gs.system_utils import mkdir_p
from plyfile import PlyData, PlyElement
from utils_gs.sh_utils import RGB2SH
from simple_knn._C import distCUDA2
from utils_gs.graphics_utils import BasicPointCloud
from utils_gs.general_utils import strip_symmetric, build_scaling_rotation
...
class GaussianModel:
    ...
    def load_ply(self, path, use_train_test_exp = False, device="cpu"):
