...
class RenderViewers():
            ...
            # for t in range(num_timestamps): 
                ...
                while True:
                    ...
                    if (theta > self.theta_limits[0] and   theta < self.theta_limits[1] )  and (phi > self.phi_limits[0] and \
                        ...
                        # w2c = rotate_pose_around_z(w2c, -5)
                        # print(repr(c2w))
                    else:
                    ...
                    self.img  = reduce_color_depth_with_dithering(img, bits=60)
                    # startTime= time.time()
                    # self.img = ema_filter.process_frame(img)  
                    # print(time.time()- startTime)
                    # if old_proggress_bar_value > 0:
                    
                    if old_proggress_bar_value + 5 < self.gui_slider_bar_text.value  or old_proggress_bar_value - 5 > self.gui_slider_bar_text.value:
    ...
    def init_camera(cls, y_angle=180., center_dist=5., cam_height= 1.5, f_ratio=0.82):
        ...
        w2c = np.array([[np.cos(ry), 0., -np.sin(ry), -0.0],
                        ...
                        [0.,         0., 0.,          1.]])
        c2w = np.array([[ 9.65376285e-01,  1.03837663e-01,  2.39303924e-01,
        -2.78857353e+00],
       [-1.00031852e-01,  9.94589363e-01, -2.80290359e-02,
         1.43415736e+00],
       [-2.40919607e-01,  3.12055192e-03,  9.70540059e-01,
        -4.45626757e+00],
...
def rotate_pose_around_z(pose, theta):
...
if __name__ == "__main__":
    ...
    exp_name = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_scl1_test3"
    sequence = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_aligned"

    exp_name = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned_test36"
    sequence = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned"
    
    # exp_name = "2025-05-20_18-21-50_tahir_2_lumi_adj_scl1_enhanced_test3"
