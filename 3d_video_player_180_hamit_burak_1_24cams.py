...
class RenderViewers():
        ...
        while self.running:
            ...
            # for t in range(num_timestamps): 
                ...
                while True:
                    ...
                    self.img  = reduce_color_depth_with_dithering(img, bits=120)
                    # startTime= time.time()
    ...
    def init_camera(cls, y_angle=180., center_dist=5., cam_height= 1.5, f_ratio=0.82):
        ...
        w2c = np.array([[np.cos(ry), 0., -np.sin(ry), -0.0],
                        ...
                        [0.,         0., 0.,          1.]])
        c2w = np.array([[ 6.72220477e-01,  1.04636069e-01, -7.32919452e-01,
         6.41564380e+00],
       [-7.54389906e-02,  9.94490237e-01,  7.27882375e-02,
         4.60706743e-01],
       [ 7.36497515e-01,  6.36095994e-03,  6.76410341e-01,
        -2.96109327e+00],
...
if __name__ == "__main__":
    ...
    exp_name = "2025-05-20_18-24-20_hamit_burak_1_half_all_scl_1_enhanced_60_flicker_dev76"
    sequence = "2025-05-20_18-24-20_hamit_burak_1_half_all"
    ...
    # exp_name = "2025-05-20_18-21-50_tahir_2_lumi_adj_scl1_enhanced_test31"
    # sequence = "2025-05-20_18-21-50_tahir_2_lumi_adj"


    # exp_name = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned_start_355-450_interpolated_exp_1_test19"
    # sequence = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned"

    exp_name = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned_start_0-450_interpolated_exp_1_test1"
    sequence = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned"

    # exp_name = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned_30fps_start_462_test1"
    # sequence = "2025-05-20_18-21-50_tahir_2_fullsize_lumi_adj_aligned_30fps"

    # exp_name = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_60fps_scl1_test1"
    # sequence = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_60fps"

    exp_name = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_scl1_test31"
    sequence = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj"

  
    # exp_name = "2025-05-20_18-24-20_hamit_burak_1_new_scl1_test1"
    # sequence = "2025-05-20_18-24-20_hamit_burak_1_new"

    # exp_name = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_cam6_scl1_test8"
    # sequence = "2025-05-20_18-24-20_hamit_burak_1_lumi_adj_cam6"


        
    viewer = Viewer(seq=sequence, exp=exp_name,  port=8087, title="Demo1 Spaceport", w=1920, h=1080)
    time.sleep(0.2)
    viewer.start_viewer()
